...
# Function to generate random points on the map
# def generate_random_points(start,goal, width=600, height=200):
...
# Heuristic function to compute the distance between two nodes
...
# Backtrack function to create a path from parents
...
#######################################################################
#######################################################################
################# enter the input of the start and goal ###############

start, goal = (20, 20), (580, 50)

#######################################################################
#######################################################################
#######################################################################

start_input = input("Enter the start coordinates (x, y): ")
goal_input = input("Enter the goal coordinates (x, y): ")
...
def find_mid(start, goal, no_go_points):
    ...
    while mid in no_go_points:
        mid_x = (((x_1 + mid_x)/2) + mid_x)/2
        mid_y = (((y_1 + mid_y)/2) + mid_y)/2
        mid = (int(mid_x),int(mid_y))
    return mid
